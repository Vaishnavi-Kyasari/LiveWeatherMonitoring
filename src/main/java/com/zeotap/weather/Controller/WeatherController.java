...
public class WeatherController {
    ...
    public ResponseEntity<WeatherSummary> getDailySummary(@PathVariable String date) {
        LocalDate localDate = LocalDate.parse(date);
        WeatherSummary summary = rollupService.generateDailySummary(localDate);
    ...
    // New endpoint to generate a daily summary via POST
    ...
    // New endpoint to generate all daily summaries via POST
    @PostMapping("/summary/all")
    public ResponseEntity<Map<LocalDate, WeatherSummary>> generateAllDailySummaries() {
        Map<LocalDate, WeatherSummary> summaries = rollupService.generateAllDailySummaries();
        return ResponseEntity.ok(summaries);
    }
}
